 ...
 */
    ...
    List<Policy> findByCategoriesIn(List<String> categories);

    @Query("SELECT p FROM Policy p ORDER BY RAND() LIMIT :limit")
    List<Policy> findRandomPolicies(@Param("limit") int limit);
}
